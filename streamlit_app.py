...
min_profit = st.sidebar.slider("Min Profit (£)", 0.0, 10.0, 0.50, help="Hide bets that make less than this.")

ghost_mode = st.sidebar.checkbox("👻 Ghost Mode", value=False, help="Round bets to nearest £1 to avoid detection.")
...
def display_arbs(results):
    ...
    if count == 0:
        ...
        st.warning(f"No arbs found above £{min_profit:.2f} profit.")
